...
def round_robin_iteration(num_categories, agent_set, current_state, step_size=1):
    ...
    while not trade_found and num_offers < max_offers:
        ...
        intersection_offer = []
        # TODO Add Nash Update heare instead of feasibility
        intersection_offer = mediator.find_intersection()


        # print("Intersection Offer: ", intersection_offer, mediator.cone_information[0]['center_of_cone'], mediator.cone_information[0]['theta'], mediator.cone_information[1]['center_of_cone'], mediator.cone_information[1]['theta'], np.rad2deg(angle_between(mediator.cone_information[0]['center_of_cone'], mediator.cone_information[1]['center_of_cone'])))
        if len(intersection_offer) != 0:
            ...
            while not scaling_value:
                ...
                if all(responses) == True:
                    # print("Scaled: ", scaled_intersection_offer, step_size, intersection_offer, responses)
                    trade_found = True
