...
def solve_nbs_first_order_simplex(Sigma_list, lambda_mu_list, starting_point=None,
    ...
    for step in range(steps):
        ...
        for i in range(m):
            ...
            if u_i <= disagreement:
                continue
            grad_i = -compute_simplex_gradient(w, Sigma_list[i], lambda_mu_list[i])
...
def run_our_solution_concept_actual(x0, Sigma_set, lambda_mu_set, x_i_set, steps=1000, step_size=0.01, barrier_coeff=1e-6):
    """
